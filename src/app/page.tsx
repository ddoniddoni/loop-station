...
import { LoopSaveStatus } from "@/components/studio/loop-save-status";
    ...
    <AudioEngineProvider>
      <div className="station-app">
        ...
        <header className="station-header">
          ...
          <StudioNavigation />
          <div className="station-session"><Heading as="h1" size="3">{ko.studioSessionName}</Heading><LoopSaveStatus /></div>
          <AudioSetup />
        </header>
